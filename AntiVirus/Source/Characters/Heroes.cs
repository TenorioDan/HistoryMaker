...
namespace AntiVirus.Source.Characters
{
	...
	public class JesusChrist : Character
	{
		public JesusChrist(Texture2D spriteSheet)
			: base(spriteSheet)
		{
			animationCount = 8;
			IDLE_ANIMATION_UP_INDEX = 0;
	...
	public class GeorgeWashingon : Character
	{
		public GeorgeWashingon(Texture2D spriteSheet)
			: base(spriteSheet)
		{
			animationCount = 8;
			IDLE_ANIMATION_UP_INDEX = 0;
